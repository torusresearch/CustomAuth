...
export const registerServiceWorker = baseRouteUrl => {
  const swIntegrity = "SERVICE_WORKER_SHA_INTEGRITY"; // string-replaced
  const swUrl = `${baseRouteUrl}sw.js`;
      ...
      navigator.serviceWorker
        ...
        .then(responseObject => {
          ...
          if (responseObject.err) {
            ...
            if (baseRouteUrl !== "/") {
              finalArray.push(navigator.serviceWorker.register(swUrl, { updateViaCache: "all", scope: baseRouteUrl }));
            }
