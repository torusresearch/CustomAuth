...
export const testnetVerifierMap: Record<string, LoginProviderItem> = {
  [GOOGLE]: {
    name: "Google",
    typeOfLogin: "google",
...
export const sapphireDevnetVerifierMap: Record<string, LoginProviderItem> = {
  [GOOGLE]: {
    name: "Google",
    typeOfLogin: "google",
...
export const DEFAULT_NETWORK = TORUS_SAPPHIRE_NETWORK.SAPPHIRE_DEVNET as TORUS_NETWORK_TYPE;

export const getVerifierMap = (network: TORUS_NETWORK_TYPE): Record<string, LoginProviderItem> =>
  network === TORUS_LEGACY_NETWORK.TESTNET ? testnetVerifierMap : sapphireDevnetVerifierMap;

export const verifierMap = getVerifierMap(DEFAULT_NETWORK);

export const uxModeOptions: OptionItem[] = Object.values(UX_MODE).map((value) => ({ name: String(value), value: String(value) }));
export const networkList: TORUS_NETWORK_TYPE[] = [TORUS_SAPPHIRE_NETWORK.SAPPHIRE_DEVNET, TORUS_LEGACY_NETWORK.TESTNET];
export const networkOptions: OptionItem[] = networkList.map((value) => ({ name: String(value), value: String(value) }));
export const sapphireDevnetVerifierOptions: OptionItem[] = Object.keys(sapphireDevnetVerifierMap).map((value) => ({ name: value, value }));
export const testnetVerifierOptions: OptionItem[] = Object.keys(testnetVerifierMap).map((value) => ({ name: value, value }));

export const getVerifierOptions = (network: TORUS_NETWORK_TYPE): OptionItem[] =>
  network === TORUS_LEGACY_NETWORK.TESTNET ? testnetVerifierOptions : sapphireDevnetVerifierOptions;
