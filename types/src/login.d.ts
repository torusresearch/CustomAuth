...
import { AggregateLoginParams, DirectWebSDKArgs, HybridAggregateLoginParams, InitParams, SubVerifierDetails, TorusAggregateLoginResponse, TorusKey, TorusLoginResponse } from "./handlers/interfaces";
declare class DirectWebSDK {
    ...
    triggerHybridAggregateLogin({ singleLogin, aggregateLoginParams }: HybridAggregateLoginParams): Promise<unknown>;
