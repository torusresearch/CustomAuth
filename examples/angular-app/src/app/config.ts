...
export const sapphireDevnetVerifierMap = {
  ...
  [FACEBOOK]: {
    name: "Facebook",
    typeOfLogin: "facebook",
    clientId: "226597929760394",
    verifier: "web3auth-facebook-sapphire-devnet",
  },
  [REDDIT]: {
    name: "Reddit",
    typeOfLogin: "custom",
  ...
  [TWITCH]: {
    name: "Twitch",
    typeOfLogin: "twitch",
    clientId: "94nxxpy7inarina6kc9hyg2ao3mja2",
    verifier: "web3auth-twitch-sapphire-devnet",
  },
  [DISCORD]: {
    name: "Discord",
    typeOfLogin: "discord",
    clientId: "1126902533936394330",
    verifier: "web3auth-discord-sapphire-devnet",
  },
  [APPLE]: {
    name: "Apple",
    typeOfLogin: "apple",
    clientId: "ADG0f0EZsBHvcbu2in7W938XngxJQJrJ",
    verifier: "web3auth-auth0-apple-sapphire-devnet",
  },
  [GITHUB]: {
    name: "Github",
    typeOfLogin: "github",
  ...
  [LINE]: {
    name: "Line",
    typeOfLogin: "line",
    clientId: "AUDHMShLlzzS15cb9F8IjYQHBbfWO5iB",
    verifier: "web3auth-auth0-line-sapphire-devnet",
  },
  [WEB3AUTH_EMAIL_PASSWORDLESS]: {
    name: "Web3Auth Email Passwordless",
    typeOfLogin: "email_passwordless",
...
export const uxModeOptions = Object.values(UX_MODE);

export const networkList = [TORUS_SAPPHIRE_NETWORK.SAPPHIRE_DEVNET, TORUS_LEGACY_NETWORK.TESTNET];
export const networkOptions = networkList;

export const sapphireDevnetVerifierOptions = Object.keys(sapphireDevnetVerifierMap);
export const testnetVerifierOptions = Object.keys(testnetVerifierMap);
